<div>
        ...
        <div class="mt-10 sm:mt-0">
            <x-jet-form-section submit="addTeamMember">
                ...
                <x-slot name="description">
                    Add players to your campaign, allowing them to make
                    characters and participate in games.
                </x-slot>
                ...
                <x-slot name="form">
                    ...
                    @if (count($this->roles) > 0)
                        <div class="col-span-6 lg:col-span-4">
                            ...
                            <div
                                class="
                                    relative z-0 mt-1 border border-gray-200
                            ...
                            >
                                @foreach ($this->roles as $index => $role)
                                    <button
                                        type="button"
                                        class="
                                            relative px-4 py-3 inline-flex
                                    ...
                                    >
                                        <div
                                            class="
                                                {{ isset($addTeamMemberForm['role']) && $addTeamMemberForm['role'] !== $role->key ? 'opacity-50' : '' }}
                                            "
                                        >
                                            <!-- Role Name -->
                                            <div class="flex items-center">
                                                <div
                                                    class="
                                                        ...
                                                        {{ $addTeamMemberForm['role'] == $role->key ? 'font-semibold' : '' }}
                                                    "
                                                >
                                                    {{ $role->name }}
                                                </div>
    ...
    @if ($team->teamInvitations->isNotEmpty() && Gate::check('addTeamMember', $team))
        ...
        <div class="mt-10 sm:mt-0">
            <x-jet-action-section>
                ...
                <x-slot name="description">
                    These people have been invited to your campaign and have
                    been sent an invitation email. They may join by accepting
    ...
    @if ($team->users->isNotEmpty())
        ...
        <div class="mt-10 sm:mt-0">
            <x-jet-action-section>
                ...
                <x-slot name="description">
                    All of the people that are part of this campaign.
                </x-slot>
    ...
    <x-jet-dialog-modal wire:model="currentlyManagingRole">
        ...
        <x-slot name="content">
            <div
                class="relative z-0 mt-1 border border-gray-200 rounded-lg
                cursor-pointer"
            >
                @foreach ($this->roles as $index => $role)
                    <button
                    ...
                    >
                        <div
                            class="
                                {{ $currentRole !== $role->key ? 'opacity-50' : '' }}
                            "
                        >
                            <!-- Role Name -->
                            <div class="flex items-center">
                                <div
                                    class="
                                        text-sm text-gray-600
                                        {{ $currentRole == $role->key ? 'font-semibold' : '' }}
                                    "
                                >
                                    {{ $role->name }}
                                </div>
        ...
        <x-slot name="footer">
            ...
            <x-jet-button
                class="ml-2" wire:click="updateRole"
    ...
    <x-jet-confirmation-modal wire:model="confirmingLeavingTeam">
        ...
        <x-slot name="content">
            Are you sure you would like to leave this campaign?
        </x-slot>
        ...
        <x-slot name="footer">
            ...
            <x-jet-danger-button
                class="ml-2" wire:click="leaveTeam" wire:loading.attr="disabled"
            >
                Leave
            </x-jet-danger-button>
        </x-slot>
    ...
    <x-jet-confirmation-modal wire:model="confirmingTeamMemberRemoval">
        <x-slot name="title">
            Remove Player Member
        </x-slot>

        <x-slot name="content">
            Are you sure you would like to remove this person from the campaign?
        </x-slot>
        ...
        <x-slot name="footer">
            ...
            <x-jet-danger-button
                class="ml-2" wire:click="removeTeamMember"
                wire:loading.attr="disabled"
            >
                Remove
            </x-jet-danger-button>
